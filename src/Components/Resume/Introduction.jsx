...
export default function Introduction() {
    ...
    return (
        <>
            <Header>
                <Name variant="h1">Prabhat<Lastname>Kumar</Lastname><Lastname> Verma</Lastname></Name>
                <Title>
            ...
            <WorkExperience>
                ...
                {!state.checkedB ?
                    <div className={classes.navigation}>
                        ...
                        >
                            <Tab className={classes.tabsLeft} label="2020.09-2021.12" {...a11yProps(0)} />
                ...
                {state.checkedB ?
                    <div className={classes.navigation}>
                        ...
                        <TabPanel className={classes.tabsRight} value={value} index={0}>
                            ...
                            <ProfileDetails>
                                Completed my graduation with 73 percentage and participated in various events and hackathons during
                ...
                <li>
                    <AnchorLinks href="https://www.udemy.com/certificate/UC-10cb48cd-dd3f-400e-a2ea-d6e2a8d7b5f7/" target="_blank">

                        Full Stack Java Developer
                    </AnchorLinks>
                </li>
                <li>
                    <AnchorLinks href="https://www.udemy.com/certificate/UC-a0ba0c6f-67b3-4d34-ac91-aead5d2ab825/" target="_blank">
